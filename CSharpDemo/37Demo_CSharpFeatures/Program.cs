...
namespace _37Demo_CSharpFeatures
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // aNonymous MEthods: Methods without name, local methods, can not be used
            // elesewhere in application, used for short purposes, like conditional check OR
            // holder
            ...
            // Predicate is in-built delegate which always points
            // to a method which checks some condition and
            // returns true/ false - boolean kind of output
            ...
            //// Extending in-built Data Types functionalities by writting 
            ///specific classes using below Rules:
    ...
    public class MyCustomCollection : IEnumerable
    {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            {
                yield return arr[i];
                // yield keyword forces CLR to remeber last element index,
                // which we have returned from this for loop and next time returns
                // next element by increasing index as per the for loop syntax
                // condition.
            }
        }
    }
